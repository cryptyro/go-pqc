...
func marshalPublicKey(pub any) (publicKeyBytes []byte, publicKeyAlgorithm pkix.AlgorithmIdentifier, err error) {
	...
	case *xdsa.PublicKey:
		...
		if err != nil || len(publicKeyBytes) != xdsa.PublicKeySize {
			return nil, pkix.AlgorithmIdentifier{}, errors.New("x509: invalid EdDilithium3 key")
		}
		publicKeyAlgorithm.Algorithm = oidPublicKeyEDMLDSA
...
var (
	...
	oidSignatureEDMLDSA 	=asn1.ObjectIdentifier{1, 2, 840, 10045, 4, 3, 2, 1}
...
var signatureAlgorithmDetails = []struct {
	...
	{PureEDMLDSA, "EDMLDSA-SHA256", oidSignatureEDMLDSA, emptyRawValue, EDMLDSA, crypto.SHA256, false},
}
...
var (
	...
	oidPublicKeyEDMLDSA = asn1.ObjectIdentifier{1, 2, 840, 54321, 1, 3}
	// RFC 8410, Section 3
	//
...
func getPublicKeyAlgorithmFromOID(oid asn1.ObjectIdentifier) PublicKeyAlgorithm {
	...
	case oid.Equal(oidPublicKeyECDSA):
		return ECDSA
	case oid.Equal(oidPublicKeyEDMLDSA):
		return EDMLDSA
...
func checkSignature(algo SignatureAlgorithm, signed, signature []byte, publicKey crypto.PublicKey, allowSHA1 bool) (err error) {
	...
	case *ecdsa.PublicKey:
		...
		return
	case *xdsa.PublicKey:
		if pubKeyAlgo != EDMLDSA {
			return signaturePublicKeyAlgoMismatchError(pubKeyAlgo, pub)
		}
		if !xdsa.Verify(pub, signed, signature) {
			return errors.New("x509: MLDSA verification failure")
		}
		return nil
	case ed25519.PublicKey:
		if pubKeyAlgo != Ed25519 {
...
func signingParamsForKey(key crypto.Signer, sigAlgo SignatureAlgorithm) (SignatureAlgorithm, pkix.AlgorithmIdentifier, error) {
	...
	case *xdsa.PublicKey:
		pubType = EDMLDSA
		defaultAlgo = PureEDMLDSA

	default:
		return 0, ai, errors.New("x509: only RSA, EDMLDSA, ECDSA and Ed25519 keys supported")
	}

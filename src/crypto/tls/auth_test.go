...
func TestSignatureSelection(t *testing.T) {
	...
	edmldsaCert := &Certificate{
		Certificate: [][]byte{testEDMLDSACertificate},
		PrivateKey:  testEDMLDSAPrivateKey,
	}
	...
	tests := []struct {
		...
		{edmldsaCert, []SignatureScheme{PureEDMLDSA}, VersionTLS12, PureEDMLDSA, signatureEDMLDSA, directSigning},
		{edmldsaCert, []SignatureScheme{PureEDMLDSA}, VersionTLS13, PureEDMLDSA, signatureEDMLDSA, directSigning},
	...
	badTests := []struct {
		...
		{edmldsaCert, []SignatureScheme{ECDSAWithP256AndSHA256, ECDSAWithSHA1}, VersionTLS12},
